	...
	<div class="col-xl-12 page-content p-0">
		<div class="inner-box">
			...
			<div class="row">
					...
					<?php if(isset($cities)): ?>
						<div class="relative location-content">
							...
							<div class="col-xl-12 tab-inner">
								<div class="row">
									<?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<ul class="cat-list <?php echo e($ulCol); ?> <?php echo e((count($cities) == $key+1) ? 'cat-list-border' : ''); ?>">
											<?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<li>
													<?php if($city->id == 999999999): ?>
														<a href="#browseAdminCities" id="dropdownMenu1" data-toggle="modal"><?php echo $city->name; ?></a>
													<?php else: ?>
														<?php $attr = ['countryCode' => config('country.icode'), 'city' => slugify($city->name), 'id' => $city->id]; ?>
														<a href="<?php echo e(lurl(trans('routes.v-search-city', $attr), $attr)); ?>">
							...
							<?php if($loc['showButton']): ?>
								...
								<?php else: ?>
									<a class="btn btn-lg btn-add-listing pl-4 pr-4" href="<?php echo e(addPostURL()); ?>" style="text-transform: none;">
										<i class="fa fa-plus-circle"></i> <?php echo e(t('Add Listing')); ?>
				...
				<?php echo $__env->make('layouts.inc.tools.svgmap', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
			</div>
