		...
		<div class="modal-content">
			...
			<div class="modal-header">
				<h4 class="modal-title">
					<i class="icon-mail-2"></i> <?php echo e(t('Contact advertiser')); ?>
			...
			<form role="form" method="POST" action="<?php echo e(lurl('posts/' . $post->id . '/contact')); ?>" enctype="multipart/form-data">
				...
				<div class="modal-body">
						...
						<?php else: ?>
							...
							<div class="form-group required">
								...
								<div class="input-group">
									...
									<input id="from_email" name="from_email" type="text" placeholder="<?php echo e(t('i.e. you@gmail.com')); ?>"
						...
						<div class="form-group required">
							...
							<div class="input-group">
								<input id="from_name"
									   ...
									   placeholder="<?php echo e(t('Your name')); ?>"
									   type="text"
					...
					<div class="form-group required">
						<label for="phone" class="control-label"><?php echo e(t('Phone Number')); ?>
					...
					<div class="form-group required">
						...
						<textarea id="message"
								  ...
								  placeholder="<?php echo e(t('Your message here...')); ?>"
								  rows="5"
					...
					<?php if(isset($parentCat) and isset($parentCat->type) and in_array($parentCat->type, ['job-offer'])): ?>
						...
						<div class="form-group required" <?php echo (config('lang.direction')=='rtl') ? 'dir="rtl"' : ''; ?>>
							...
							<small id="" class="form-text text-muted">
								<?php echo e(t('File types: :file_types', ['file_types' => showValidFileTypes('file')])); ?>
					...
					<?php echo $__env->make('layouts.inc.tools.recaptcha', ['label' => true], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
				...
				<div class="modal-footer">
					...
					<button type="submit" class="btn btn-success pull-right"><?php echo e(t('Send message')); ?></button>
				</div>
			</form>
