			...
			<div class="row">
						...
						<div class="footer-col">
							...
							<ul class="list-unstyled footer-nav">
								<?php if(!auth()->user()): ?>
									<li>
										<?php if(config('settings.security.login_open_in_modal')): ?>
											<a href="#quickLogin" data-toggle="modal"> <?php echo e(t('Log In')); ?> </a>
										<?php else: ?>
											<a href="<?php echo e(lurl(trans('routes.login'))); ?>"> <?php echo e(t('Log In')); ?> </a>
										<?php endif; ?>
									</li>
								...
								<?php else: ?>
									...
									<li><a href="<?php echo e(lurl('account/my-posts')); ?>"> <?php echo e(t('My ads')); ?> </a></li>
									<li><a href="<?php echo e(lurl('account/favourite')); ?>"> <?php echo e(t('Favourite ads')); ?> </a></li>
								<?php endif; ?>
							</ul>
						</div>
					</div>
				...
				<div class="col-xl-12">
					...
					<div class="copy-info text-center">
						© <?php echo e(date('Y')); ?> <?php echo e(config('settings.app.app_name')); ?>. <?php echo e(t('All Rights Reserved')); ?>.
						<?php if(!config('settings.footer.hide_powered_by')): ?>
							<?php if(config('settings.footer.powered_by_info')): ?>
								<?php echo e(t('Powered by Classics Area')); ?>

								<?php echo e(t('Powered by')); ?> <a href="http://www.classicsarea.com" title="classicsarea">ClassicsArea</a>.
							<?php endif; ?>
						<?php endif; ?>
					</div>
				</div>
