        ...
        <div class="container">
			...
			<div class="navbar-identity">
				...
				<a href="<?php echo e(url(config('app.locale') . '/')); ?>" class="navbar-brand logo logo-title">
					<img src="<?php echo e(\Storage::url(config('settings.app.logo', 'app/default/logo.png')) . getPictureVersion()); ?>" class="tooltipHere main-logo" />
				</a>
				...
				<ul class="nav navbar-nav ml-auto navbar-right">
                    <?php if(!auth()->check()): ?>
                        <li class="nav-item">
							<a href="<?php echo e(url(config('app.locale') . '/' . trans('routes.login'))); ?>" class="nav-link">
								<i class="icon-user fa"></i> <?php echo e(t('Log In')); ?>
                        ...
                        <li class="nav-item">
							...
							<?php else: ?>
								<a href="<?php echo e(url(config('app.locale') . '/logout')); ?>" class="nav-link">
									<i class="glyphicon glyphicon-off"></i> <?php echo e(t('Log Out')); ?>
							...
							<ul id="userMenuDropdown" class="dropdown-menu user-menu dropdown-menu-right shadow-sm">
                                ...
                                <li class="dropdown-item">
									<a href="<?php echo e(url(config('app.locale') . '/account/my-posts')); ?>">
										<i class="icon-th-thumb"></i> <?php echo e(t('My ads')); ?>
                                ...
                                <li class="dropdown-item">
									<a href="<?php echo e(url(config('app.locale') . '/account/pending-approval')); ?>">
										<i class="icon-hourglass"></i> <?php echo e(t('Pending approval')); ?>

									</a>
								</li>
                                <li class="dropdown-item">
									<a href="<?php echo e(url(config('app.locale') . '/account/archived')); ?>">
										<i class="icon-folder-close"></i> <?php echo e(t('Archived ads')); ?>
					...
					<li class="nav-item postadd">
						<?php if(!auth()->check()): ?>
							...
							<?php else: ?>
								<a class="btn btn-block btn-border btn-post btn-add-listing" href="<?php echo e(addPostURL(true)); ?>">
									<i class="fa fa-plus-circle"></i> <?php echo e(t('Add Listing')); ?>
