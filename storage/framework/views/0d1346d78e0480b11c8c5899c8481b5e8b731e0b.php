		...
		<div class="modal-content">
			...
			<form role="form" method="POST" action="<?php echo e(lurl(trans('routes.login'))); ?>">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						<label class="checkbox form-check-label pull-left mt-2" style="font-weight: normal;">
							<input type="checkbox" value="1" name="remember" id="mRemember" class="<?php echo e($rememberError); ?>"> <?php echo e(t('Keep me logged in')); ?>
				...
				<div class="modal-footer">
					...
					<button type="submit" class="btn btn-success pull-right"><?php echo e(t('Log In')); ?></button>
				</div>
			</form>
