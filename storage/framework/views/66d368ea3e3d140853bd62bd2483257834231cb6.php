				...
				<div class="row m-0">
					<div class="col-xl-3 col-md-3 col-sm-12 col-xs-12">
						<select name="c" id="catSearch" class="form-control selecter">
							<option value="" <?php echo e(($qCategory=='') ? 'selected="selected"' : ''); ?>> <?php echo e(t('All Categories')); ?> </option>
							<?php if(isset($cats) and $cats->count() > 0): ?>
								<?php $__currentLoopData = $cats->groupBy('parent_id')->get(0); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemCat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<option <?php echo e(($qCategory==$itemCat->tid) ? ' selected="selected"' : ''); ?> value="<?php echo e($itemCat->tid); ?>"> <?php echo e($itemCat->name); ?> </option>
